// Small inline SVG icons for nav items — same reasoning as Logo.tsx: no icon
// library/font, no extra request, themeable via currentColor.
...
export function InfoIcon({ size = 16 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden="true">
      ...
      <path d="M12 8.5h.01M11.25 11h1.25v5.5h1" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
